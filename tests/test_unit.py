...
def test_normalize():
    ...
    # with config
    m.config_normalization.init_data_params(df, m.config_covar, m.regressors_config, m.config_events)
...
def test_globaltimedataset():
    ...
    for m in [m1, m2, m3]:
        ...
        config_normalization.init_data_params(df_global, m.config_covar, m.regressors_config, m.config_events)
    ...
    for m in [m4]:
        df4
        config_normalization.init_data_params(df4, m.config_covar, m.regressors_config, m.config_events)
        m.config_normalization = config_normalization
