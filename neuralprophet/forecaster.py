...
from neuralprophet.time_dataset import FastTensorDataLoader
...
class NeuralProphet:
    ...
    def _train(self, df, df_val=None, minimal=False, metrics=False, checkpointing=False, continue_training=False):
        """
